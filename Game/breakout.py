...
# class game_ball():
    ...
    def draw(self):
        pygame.draw.circle(screen, paddle_col, (self.rect.x, self.rect.y), self.ball_rad)
        pygame.draw.circle(screen, paddle_outline, (self.rect.x, self.rect.y), self.ball_rad, 3)
